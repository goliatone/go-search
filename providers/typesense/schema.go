...
func fixedFieldSpecs() map[string]schemaFieldSpec {
	return map[string]schemaFieldSpec{
		...
		"result_id":                {Type: "string", Facet: true, Optional: true},
		"result_type":              {Type: "string", Facet: true, Optional: true},
		"match_location":           {Type: "string", Facet: true, Optional: true},
		"match_field":              {Type: "string", Optional: true},
		"chunk_ordinal":            {Type: "int32", Sort: true, Optional: true},
		...
		"scope_labels_fingerprint": {Type: "string", Facet: true, Optional: true},
